...
<center>
    ...
    <asp:gridview runat="server" cssclass="table table-striped " Id="gvNotaDeCredito" OnRowCommand="gvNotaDeCredito_RowCommand"  Width="1000px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None"  >
