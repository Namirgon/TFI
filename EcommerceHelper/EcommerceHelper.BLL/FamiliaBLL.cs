 ...
 public    class FamiliaBLL
    {
        ...
        FamiliaDAL GestorFamilia = new FamiliaDAL();
        ...
        public void FamiliaTraerSubPermisos(List<IFamPat> unasFamilias)
        {
            ...
            {
                ServicioLog.CrearLog(es, "FamiliaTraerSubPermisos", "", Helpers.ConfigSection.Default.Site.NumeroDocumento.ToString());
                throw;
            }
        }
        ...
        public void FamiliaUnaTraerSubPermisos(IFamPat unaFamilia)
        {
            ...
            {
                ServicioLog.CrearLog(es, "FamiliaUnaTraerSubPermisos", "", Helpers.ConfigSection.Default.Site.NumeroDocumento.ToString());
                throw;
            }
        }
        ...
        public List<IFamPat> PermisosTraerTodos()
        {
            ...
            {
                ServicioLog.CrearLog(es, "PermisosTraerTodos", "", Helpers.ConfigSection.Default.Site.NumeroDocumento.ToString());
                throw;
            }
        }
