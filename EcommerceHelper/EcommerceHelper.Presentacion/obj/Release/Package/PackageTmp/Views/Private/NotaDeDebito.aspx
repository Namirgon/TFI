<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/PaginaMaestraAdministracion.Master" AutoEventWireup="true" CodeBehind="NotaDeDebito.aspx.cs" Inherits="EcommerceHelper.Presentacion.Views.Private.NotaDeDebitoaspx" %>
...
<center>
    ...
    <asp:gridview runat="server" cssclass="table table-striped " Id="gvNotaDeDebito" OnRowCommand="gvNotaDeDebito_RowCommand"  Width="700px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None"  >
...
<ControlStyle BackColor="Red" ForeColor="White"></ControlStyle>
   ...
   <br />
        <center>
        <asp:DetailsView ID="DetalleND" runat="server" Height="50px" Width="325px" BackColor="White" AutoGenerateRows="False" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
