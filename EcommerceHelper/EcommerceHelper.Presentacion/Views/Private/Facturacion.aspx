...
<div class="mibody2" >
   ...
   <br />
     ...
     <h2 style="margin-left:60px" > <asp:Label ID="Factura" runat="server" ClientIDMode="Static" > </asp:Label>
                </h2>
            </div>
        </div>
   <br />
...
<ControlStyle BackColor="Red" ForeColor="White"></ControlStyle>
   ...
   <br />
        <center>
        <asp:DetailsView ID="DetalleFactura" runat="server" Height="50px" Width="325px" BackColor="White" AutoGenerateRows="False" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
